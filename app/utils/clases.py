class Powerplant:
    def __init__(self, name: str, tipe: str, efficiency: float, pmin: int, pmax: int, price: float):
        self.name = name
        self.tipe = tipe
